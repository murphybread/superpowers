...
## Kanban
- Board: `<project_root>/kanban.md`
- Archive: `<project_root>/kanbanArchive.md`
- RULE: If the target project contains `kanban.md`, read it before starting kanban-related work. If the project also contains `kanbanArchive.md`, use the same directory for archive updates.
